...
public class SoundController : MonoBehaviour {
    ...
    void Start()
    {
        engineSource1 = CreateAudioSource(engine, "Engin Audio1");
        ...
        transmissionOffSource = CreateAudioSource(transmission[1], "Tranmission Off Audio");
	...
	void Update () {
		engineSource1.pitch = 0.3f + drivetrain.rpm / drivetrain.powerRPM;
